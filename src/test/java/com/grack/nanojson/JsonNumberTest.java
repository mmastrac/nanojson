...
public class JsonNumberTest {
	...
	public void testBasicNumberWrite() {
		...
		assertEquals("[1,1.0,1.0]", JsonWriter.string().array(array).end());
	}
	...
	public void testLargeIntWrite() {
		...
		assertEquals("[-300000000,300000000]", JsonWriter.string().array(array).end());
	}
	...
	public void testLongWrite() {
		...
		assertEquals("[1,-3000000000,3000000000]", JsonWriter.string().array(array).end());
	}
	...
	public void testBigIntWrite() {
		...
		assertEquals("[1,-30000000000000000000,30000000000000000000]", JsonWriter.string().array(array).end());
	}

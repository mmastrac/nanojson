...
/**
 * Extends a {@link HashMap} with helper methods to determine the underlying
 * JSON type of the map element.
 */
public class JsonObject extends HashMap<String, Object> {
	...
	/**
	 * Returns the {@link JsonArray} at the given key, or null if it does not
	...
	/**
	 * Returns the {@link JsonArray} at the given key, or the default if it
	...
	/**
	 * Returns the {@link Boolean} at the given key, or false if it does not
	 * exist or is the wrong type.
	 */
	...
	/**
	 * Returns the {@link Boolean} at the given key, or the default if it does
	...
	/**
	 * Returns the {@link Double} at the given key, or 0.0 if it does not
	 * exist or is the wrong type.
	 */
	...
	/**
	 * Returns the {@link Double} at the given key, or the default if it does
	 * not exist or is the wrong type.
	 */
	...
	/**
	 * Returns the {@link Integer} at the given key, or 0 if it does not exist
	...
	/**
	 * Returns the {@link Integer} at the given key, or the default if it does
	 * not exist or is the wrong type.
	 */
	...
	/**
	 * Returns the {@link Number} at the given key, or null if it does not
	 * exist or is the wrong type.
	 */
	...
	/**
	 * Returns the {@link Number} at the given key, or the default if it does
	 * not exist or is the wrong type.
	 */
	...
	/**
	 * Returns the {@link JsonObject} at the given key, or null if it does not
	 * exist or is the wrong type.
	 */
	...
	/**
	 * Returns the {@link JsonObject} at the given key, or the default if it
	 * does not exist or is the wrong type.
	 */
	...
	/**
	 * Returns the {@link String} at the given key, or null if it does not
	 * exist or is the wrong type.
	 */
	...
	/**
	 * Returns the {@link String} at the given key, or the default if it does
	 * not exist or is the wrong type.
	 */
	...
	/**
	 * Returns true if the object has an element at that key (even if that
	 * element is null).
	 */
